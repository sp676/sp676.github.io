...
<head>
  ...
  <title>Home Services | S-Tech</title>
...
<div class="banner">
  <div class="banner-text">
    <h1>Home Services</h1>
    <p>Home <i class="fa-solid fa-angles-right"></i> Home Services</p>
  </div>
</div>
<div class="content">
  <div class="content1">
  ...
  <ul>
    ...
    <li>Hardware Install/Upgrade</li>
...
<div class="content2">
  <ul>
    ...
    <li>File Backup/Restoration</li>
    <li>Password Recovery</li>
    <li>Physical/Electronic</li>
    <li>On-Site/In-House Servicing</li>
  </ul>
...
<div class="content3">
  ...
  <ul>
    <li>Windows/Mac OS Reinstall</li> 
    <li>Wireless Networking</li>
    <li>System Cleanup</li>
    <li>Software Install/Upgrade</li>
    <li>Data Destruction/Encryption</li>
  </ul>
</div>
</div>
<footer>
    <div class="footer">
      <div class="footer-content">
        <div class="footer-section feeback">
          ...
          <p><a href="index.php#contact" class="signin_reg"> Give Feedback </a></p>
        ...
        <div class="footer-section cf">
          <div class="cnt">
            ...
            <span><i class="fa fa-envelope"></i> &nbsp; support@s-tech.com</span>
          </div><br>
          <div class="socials">
      ...
      <div class="footer-bottom">
        &copy; s-tech.com | Designed by Santosh Poudel<br>
